            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        <div class="panel-heading panel-heading-divider">Edit Bank Receipt Voucher
                            <span class="panel-subtitle">From here you can edit Bank Receipt Voucher</span>
                        </div>
                        <div class="panel-body">
                            <div class="p-2">
                                <center>
                                    <h3><b>Edit Bank Receipt Voucher</b></h3>
                                </center>
                                <form class="user" action="{{ route('update.bank_receipt_voucher') }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                <input type="number" readonly  value="{{ $voucher->voucher_no }}" name="voucher_no" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                <input type="date" value="{{ $voucher->day }}" name="day" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="" class="text-primary">Particulars</label>
                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                <input type="text" value="{{ $voucher->particulars }}" name="particulars" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <input type="checkbox" @if($voucher->is_posted=="1") checked @endif class="" value="1" name="is_posted">
                                        ...
                                        <div class="col-md-12">
                                                ...
                                                @foreach($entries as $entry)
                                                    <tr id="row0">
                                                        <td style="width: 200px;">
                                                            <select class="select2 CustominpuWidth" required  id="account_id[]" name="account_id[]">
                                                                <option    value="">Select One</option>
                                                                @foreach($accounts as $account)
                                                                    <option @if($entry->account_id==$account->id) selected @endif value="{{$account->id}}" >{{$account->account_name}} - @if($account->Project_Name) ({{ $account->Project_Name->name }}) @endif</option>
                                                                @endforeach
                                                            </select>
                                                        </td>
                                                        <td>
                                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                                <input type="text" value="{{ $entry->remarks }}" name="description[]" class="form-control CustominpuWidth" placeholder="Description"/>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                                <input type="text" name="cheque_no[]" class="form-control " value="{{ $entry->cheque_no }}" placeholder="Cheque No."/>
                                                            </div>
                                                        </td>
                                                        <td style="width: 100px;">
                                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                                <input type="date" name="cheque_date[]" value="{{ $entry->cheque_date }}" required class="form-control "/>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                                <input type="text" name="bank_receipt_no[]" value="{{ $entry->bank_receipt_no }}" required placeholder="Bank Receipt No" class="form-control "/>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                                <input type="number" class="form-control CustominpuWidth debit" name="debit[]" id="debit{{$count}}" onkeyup="enable_disable(this.id,this.value,{{ $count }})" value="{{ $entry->debit }}" placeholder="0">
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                                <input type="number" id="credit{{$count}}" onkeyup="enable_disable(this.id,this.value,{{ $count }})" class="form-control CustominpuWidth credit" name="credit[]" value="{{ $entry->credit }}" placeholder="0">
                                                            </div>
                                                        </td>
                                                        <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="border:1px solid black;">
                                                        <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                            ...
                                                            <input type="hidden" id="debit_total2"  class="form-control">
                                                        </div>
                                                    </td>
                                                    <td style="border:1px solid black;">
                                                        <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    ...
                                                    <textarea name="amount_in_words" id="amount_in_words" class="form-control" cols="30" rows="3">{{ $voucher->amount_in_words }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <button type="submit" name="" disabled="disabled" id="" class="btn btn-primary save_data">Update</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        const baseurl = "{{url('/')}}";
        var row1=@php echo $count; @endphp;
        var inc =1;
        var c=1;
        ...
        <td>
            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                <input type="text" name="bank_receipt_no[]" placeholder="Bank Receipt No" class="form-control "/>
            </div>
        </td>
            <td>
            <div class="col-md-12 input-group input-group-sm xs-mb-15">
            <input type="number" class="form-control debit"  id="debit${inc}" onkeyup="enable_disable(this.id,this.value,${inc})" value="0" name="debit[]" placeholder="0">
            </div>
                </td>
                <td>
                <div class="col-md-12 input-group input-group-sm xs-mb-15">
...
// alert(id)  ;alert(str);alert(count);
        ...
        {
            const str = inWords($('#debit_total2').val());
