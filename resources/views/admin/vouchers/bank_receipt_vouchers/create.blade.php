            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        <div class="panel-heading panel-heading-divider">Create Bank Receipt Voucher
                            <span class="panel-subtitle">From here you can create Bank Receipt Voucher</span>
                        </div>
                        <div class="panel-body">
                            <div class="p-2">
                                <center>
                                    <h3><b>Create New Bank Receipt Voucher</b></h3>
                                </center>
                                <form class="user" action="{{ route('save.bank_receipt_voucher') }}" method="POST"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <table class="table table-bordered" id="customer">
                                                ...
                                                <tr id="row{{ $i }}">
                                                    <td style="width: 200px;">
                                                        <select class="select2 CustominpuWidth" required  id="account_id[]" name="account_id[]">
                                                            ...
                                                            @foreach($accounts as $account)
                                                                <option value="{{$account->id}}" >{{$account->account_name}} -  ({{ $account->sub_account_type }}) </option>
                                                            @endforeach
                                                        </select>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                            <input type="text" name="bank_receipt_no[]" required placeholder="Bank Receipt No" class="form-control "/>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                            <input type="number" class="form-control CustominpuWidth debit" name="debit[]" id="debit{{ $i }}" onkeyup="enable_disable(this.id,this.value,{{ $i }})" value="0" placeholder="0">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                            <input type="number" id="credit{{ $i }}" onkeyup="enable_disable(this.id,this.value,{{ $i }})" class="form-control CustominpuWidth credit" name="credit[]" value="0" placeholder="0">
                                                        </div>
                                                    </td>
                                                    <td>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            @if(\Auth::user()->role=='Super Admin')
                                                <button type="submit" name="" disabled="disabled" id="" class="btn btn-primary save_data">Create</button>
                                            @else
                                                @can('Add New Booking','Create')
                                                    <button type="submit" disabled="disabled" name="" id="" class="btn btn-primary save_data">Create</button>
                                                @endcan
                                            @endif
                                        </div>
                                    </div>
