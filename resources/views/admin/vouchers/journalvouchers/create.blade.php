            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        <div class="panel-heading panel-heading-divider">Create Journal Voucher
                            <span class="panel-subtitle">From here you can create Journal Voucher</span>
                        </div>
                        <div class="panel-body">
                            <div class="p-2">
                                <center>
                                    <h3><b>Create New Journal Voucher</b></h3>
                                </center>
                                <form class="user" action="{{ route('save.journal_voucher') }}" method="POST"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <table class="table table-bordered" id="customer">
                                                ...
                                                <tr id="row{{ $i }}">
                                                    ...
                                                    <td>
                                                        <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                            <input type="number" required class="form-control CustominpuWidth debit" name="debit[]" id="debit{{$i}}" onkeyup="enable_disable(this.id,this.value,{{ $i }})" value="0" placeholder="0">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                            <input type="number" required id="credit{{$i}}" onkeyup="enable_disable(this.id,this.value,{{ $i }})" class="form-control CustominpuWidth credit" name="credit[]" value="0" placeholder="0">
                                                        </div>
                                                    </td>
                                                    <td>
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    ...
                                                    <input type="hidden" id="debit_total2">
...
// alert(id)  ;alert(str);alert(count);
        ...
        function calc_total2()
        {
           ...
           // console.log(debit.toLocaleString());
