            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        <div class="panel-heading panel-heading-divider">Edit Journal Voucher
                            <span class="panel-subtitle">From here you can edit Journal Voucher</span>
                        </div>
                        <div class="panel-body">
                            <div class="p-2">
                                <center>
                                    <h3><b>Edit New Journal Voucher</b></h3>
                                </center>
                                <form class="user" action="{{ route('update.journal_voucher') }}" method="POST"
                                            ...
                                            <table class="table table-bordered" id="customer">
                                                ...
                                                @foreach($entries as $entry)
                                                    ...
                                                    <tr id="row{{ $count }}">
                                                        <td style="width: 275px;">
                                                            <select class="select2 CustominpuWidth" required  id="account_id[]" name="account_id[]">
                                                                ...
                                                                @foreach($accounts as $account)
                                                                    <option @if($account->id==$entry->account_id) selected @endif value="{{$account->id}}" >{{$account->account_name}} -  ({{ $account->sub_account_type }}) </option>
                                                                @endforeach
                                                            </select>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                                <input type="number" required class="form-control CustominpuWidth debit" name="debit[]" id="debit{{$count}}" onkeyup="enable_disable(this.id,this.value,{{ $count }})" value="{{ $entry->debit }}" placeholder="0">
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                                <input type="number" required id="credit{{ $count }}" onkeyup="enable_disable(this.id,this.value,{{ $count }})" class="form-control CustominpuWidth credit" name="credit[]" value="{{ $entry->credit }}" placeholder="0">
                                                            </div>
                                                        </td>
                                                        <td>
