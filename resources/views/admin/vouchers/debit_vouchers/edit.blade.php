            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        <div class="panel-heading panel-heading-divider">Edit Debit Voucher
                            <span class="panel-subtitle">From here you can edit Debit Voucher</span>
                        </div>
                        <div class="panel-body">
                            <div class="p-2">
                                <center>
                                    <h3><b>Edit Debit Voucher</b></h3>
                                </center>
                                <form class="user" action="{{ route('update.debit_voucher') }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <center>
                                                <a class="btn btn-primary btn-sm" id="internaluse-row">
                                                        ...
                                                        <td style="width: 275px;">
                                                            <select class="select2 CustominpuWidth" required  id="account_id[]" name="account_id[]">
                                                                ...
                                                                @foreach($accounts as $account)
                                                                    <option @if($account->id==$entry->account_id) selected @endif value="{{$account->id}}" >{{$account->account_name}} - @if($account->Project_Name) ({{ $account->Project_Name->name }}) @endif</option>
                                                                @endforeach
                                                            </select>
                                                        </td>
                                                        <td>
                                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                                <input type="text" name="description[]" value="{{ $entry->remarks }}" class="form-control CustominpuWidth" placeholder="Description"/>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                                <input type="number"  class="form-control CustominpuWidth debit" name="debit[]" id="debit{{$count}}" onkeyup="enable_disable(this.id,this.value,0)" value="{{ $entry->debit }}" placeholder="0">
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                                <input type="number" readonly required id="credit{{ $count }}" onkeyup="enable_disable(this.id,this.value,0)" class="form-control CustominpuWidth credit" name="credit[]" value="{{ $entry->credit }}" placeholder="0">
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <button class="security btn btn-danger btn-sm">
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", "#internaluse-row", function () {
            ...
            <input type="number" class="form-control debit"  id="debit${inc}" onkeyup="enable_disable(this.id,this.value,${inc})" value="0" name="debit[]" placeholder="0">
                ...
                <td>
                <div class="col-md-12 input-group input-group-sm xs-mb-15">
                <input type="number" class="form-control credit" readonly onkeyup="enable_disable(this.id,this.value,${inc})" id="credit${inc}" value="0"  name="credit[]" placeholder="0">
                </div>
                </td>
                <td>
