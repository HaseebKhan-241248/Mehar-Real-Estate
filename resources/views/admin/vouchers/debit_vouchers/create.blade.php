            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        <div class="panel-heading panel-heading-divider">Create Debit Voucher
                            <span class="panel-subtitle">From here you can create Debit Voucher</span>
                        </div>
                        <div class="panel-body">
                            <div class="p-2">
                                <center>
                                    <h3>
                                        <b>Create New Debit Voucher</b>
                                    </h3>
                                </center>
                                <form class="user" action="{{ route('save.debit_voucher') }}" method="POST"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <table class="table table-bordered" id="customer">
                                                ...
                                                <tr id="row0">
                                                    ...
                                                    <td>
                                                        <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                            <input type="number"  class="form-control CustominpuWidth debit" name="debit[]" id="debit0" onkeyup="enable_disable(this.id,this.value,0)" value="0" placeholder="0">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                            <input type="number" readonly id="credit0" onkeyup="enable_disable(this.id,this.value,0)" class="form-control CustominpuWidth credit" name="credit[]" value="0" placeholder="0">
                                                        </div>
                                                    </td>
                                                </tr>
                                                </tbody>
