            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        <div class="panel-heading panel-heading-divider">Edit Cash Receipt Voucher
                            <span class="panel-subtitle">From here you can edit Journal Voucher</span>
                        </div>
                        <div class="panel-body">
                            <div class="p-2">
                                <center>
                                    <h3><b>Edit Cash Receipt Voucher</b></h3>
                                </center>
                                <form class="user" action="{{ route('update.cash_receipt_voucher') }}" method="POST"
                                            ...
                                            <table class="table table-bordered" id="customer">
                                                ...
                                                @foreach($entries as $entry)
                                                    <tr id="row{{ $count }}">
                                                        ...
                                                        <td>
                                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                                <input type="number" readonly class="form-control CustominpuWidth debit" name="debit[]" id="debit{{$count}}" onkeyup="enable_disable(this.id,this.value,0)" value="{{ $entry->debit }}" placeholder="0">
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                                <input type="number" required id="credit{{ $count }}" onkeyup="enable_disable(this.id,this.value,0)" class="form-control CustominpuWidth credit" name="credit[]" value="{{ $entry->credit }}" placeholder="0">
                                                            </div>
                                                        </td>
                                                        <td>
...
// alert(id)  ;alert(str);alert(count);
        ...
        function Amount_IN_Words()
        {
            ...
            $('#amount_in_words').val(inWords(str2);
        }
    </script>
