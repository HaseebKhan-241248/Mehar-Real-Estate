            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="panel panel-default panel-border-color panel-border-color-primary">
                        <div class="panel-heading panel-heading-divider">Edit Booking
                            <span class="panel-subtitle">From here you can edit Booking</span>
                        </div>
                        <div class="panel-body">
                            <div class="p-2">
                                ...
                                <form class="user" action="{{ route('update.booking') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                ...
                                                <input type="date" value="{{ $booking->day }}" name="day" id="day" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                            ...
                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                <select name="customer_id" required id="customer_id" class="select2">
                                                    ...
                                                    @foreach($customers as $customer)
                                                        <option @if($booking->customer_id==$customer->id) selected @endif value="{{ $customer->id }}" dphone="{{ $customer->phone1 }}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                <input type="text" placeholder="Contact NO." id="customer_contact"
                                                       name="customer_contact" value="{{$booking->customer_contact}}"
                                                       class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="project_id" onchange="getSectors(this.value)" id="project_id"
                                                ...
                                                @foreach($projects as $project)
                                                    <option @if($booking->project_id==$project->id) selected @endif value="{{ $project->id }}" @if($project->GetAssignPartner)
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="sector_id" onchange="getBlocks(this.value)" id="sectors" class="select2 " required>
                                                @foreach($sectors as $sector)
                                                    <option @if($booking->sector_id==$sector->id) selected @endif value="{{ $sector->id }}">{{ $sector->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <select name="block_id" onchange="getPlots(this.value)" id="block_id" class="select2" required>
                                                @foreach($blocks as  $block)
                                                    <option @if($booking->block_id==$block->id) selected @endif value="{{ $block->id }}">{{ $block->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="plot_id" onchange="getPlotMarla(this.value)" id="plot_id" class="select2" required>
                                                @foreach($plots as $plot)
                                                    <option @if($booking->plot_id==$plot->id) selected @endif value="{{ $plot->id }}">{{ $plot->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                <input type="hidden" class="form-control" value="{{ $booking->size }}" id="size" name="size">
                                                <input type="text" readonly  class="form-control" @if($booking->MarlaSize) value="{{ $booking->MarlaSize->marla }}" @endif id="size_name">
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                <input type="number" onkeyup="calc()" step="any" placeholder="0" name="agreed_price"
                                                       id="agreed_price" class="form-control" value="{{$booking->agreed_price }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                <input type="hidden" placeholder="0" name="rate_marla" class="form-control"
                                                       id="rate_marla_hidden" value="{{ $booking->rate_marla }}">
                                                <input type="text" readonly placeholder="0" name="" class="form-control"
                                                       id="rate_marla" value="{{number_format($booking->rate_marla)}}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <label for="discount" class="text-primary">Discount Amount</label>
                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                <input type="number" step="any" onkeyup="calc()" placeholder="0" value="{{ $booking->discount }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                <input type="text" readonly id="total_amount" placeholder="0"
                                                       ...
                                                       value="{{$booking->agreed_price - $booking->discount}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                <input type="number" step="any" onkeyup="calc()" placeholder="0" value="{{ $booking->received }}"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                <input type="hidden" placeholder="0" name="remaining_amount"
                                                       id="remaining_amount_hidden" class="form-control" value="{{ $booking->remaining_amount }}">
                                                <input type="text" readonly placeholder="0" name="" id="remaining_amount"
                                                       class="form-control" value="{{ number_format($booking->remaining_amount) }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="advance_modeof_payment" class="select2" id="advance_modeof_payment">
                                                @if($booking->advance_modeof_payment=="Cash In Hand")
                                                    <option selected value="Cash In Hand">Cash In Hand</option>
                                                    <option value="Cheque">Cheque</option>
                                                    <option value="PO">PO</option>
                                                @elseif($booking->advance_modeof_payment=="Cheque")
                                                    <option value="Cash In Hand">Cash In Hand</option>
                                                    <option selected value="Cheque">Cheque</option>
                                                    <option value="PO">PO</option>
                                                @elseif($booking->advance_modeof_payment=="PO")
                                                    <option value="Cash In Hand">Cash In Hand</option>
                                                    <option value="Cheque">Cheque</option>
                                                    <option selected value="PO">PO</option>
                                                @else
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                <input type="date" onchange="diffInMonths(this.value)" class="form-control"
                                                       id="end_date" value="{{ $booking->end_date }}" name="end_date" value="">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <select onchange="MakingInstallments(0)" name="head_id" id="head_id"
                                                ...
                                                @foreach($heads as $head)
                                                    @if($head->no_of_months!='-1')
                                                        <option @if($booking->head_id==$head->id) selected @endif value="{{ $head->id }}" dmonths="{{ $head->no_of_months }}">
                                                            {{ $head->head }}</option>
                                                    @endif
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                <input type="number" step="any" placeholder="0" class="form-control"
                                                       onkeyup="MakingInstallments(0)" value="{{ $booking->no_of_installments }}"
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="select2" required name="on_account_of" id="on_account_of">
                                                ...
                                                @foreach($accounts as $account)
                                                    <option @if($booking->on_account_of==$account->id) selected @endif value="{{ $account->id }}">{{ $account->account_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                <input type="text" readonly placeholder="0" name="dp_per" id="dp_per"
                                                       class="form-control" value="{{$booking->dp_per}}">
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select name="marketer_id" id="marketer_id" class="select2">
                                                    ...
                                                    @foreach($marketers as $marketer)
                                                        <option @if($booking->marketer_id==$marketer->id) selected @endif value="{{$marketer->id}}">{{ $marketer->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                    <input type="number" step="any" class="form-control" id="marketer_commision_per"
                                                           ...
                                                           value="{{ $booking->marketer_commision_per }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                    <input type="number" step="any" class="form-control" name="marketer_coms_value_paid"
                                                           id="marketer_coms_value_paid" placeholder="0" value="{{ $booking->marketer_coms_value_paid }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                    <input type="hidden" class="form-control" name="marketer_commision_due"
                                                           ...
                                                           value="{{ $booking->marketer_commision_due }}">
                                                    <input type="text" class="form-control" readonly name=""
                                                           id="marketer_commision_due" placeholder="0"
                                                           value="{{ number_format($booking->marketer_commision_due) }}">
                                                </div>
                                            </div>
                                        </div>
                                    @else
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select name="dealer_id" id="dealer_id" class="select2">
                                                    ...
                                                    @foreach($dealers as $dealer)
                                                        <option @if($booking->dealer_id==$dealer->id) selected @endif value="{{$dealer->id}}">{{ $dealer->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                    <input type="number" step="any" class="form-control" onkeyup="calc()"
                                                           ...
                                                           value="{{ $booking->dealer_commision_per }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                    <input type="hidden" class="form-control" name="coms_formula"
                                                           ...
                                                           value="{{ $booking->coms_formula }}">
                                                    <input type="text" class="form-control" readonly name="" id="coms_formula"
                                                           placeholder="0" value="{{ number_format($booking->coms_formula) }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                    <input type="number" step="any" class="form-control" id="dealer_commision_due"
                                                           ...
                                                           value="{{ $booking->dealer_commision_due }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                    ...
                                                    @if($attachments)
                                                        ...
                                                        @foreach($attachments as $attachment)
                                                            ...
                                                            <tr id="row{{ $counter }}">
                                                                ...
                                                                <td>
                                                                    <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                                        <input name='' readonly placeholder="Comment" value="{{ $file[3] }}" type='text' class='form-control input-md' />
                                                                        <input type="hidden" @if($attachment->attachments)value="{{$attachment->attachments  }}" @endif name="old_attachments[]">
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="col-md-12 input-group input-group-sm xs-mb-15">
                                                                        <input name='comments[]' placeholder="" value="{{ $attachment->comments }}" type='text' class='form-control input-md' />
                                                                    </div>
                                                                </td>
                                                                <td>
...
@section('scripts')
    ...
    <script src="{{ asset('/assets/js/booking/makinginatallments_edit.js') }}"></script>
@endsection
